...
const jsonLd = [
  {
    ...
    description:
      "A Windows desktop trading terminal for Indian stock market traders that connects Zerodha, Upstox, Fyers, Angel One, Dhan, Alice Blue, Finvasia, Kotak Neo, and Groww in one place — enabling simultaneous bulk order execution across all accounts, consolidated P&L dashboard, auto token refresh, and live market data across NSE, BSE, NFO, MCX, and CDS.",
    brand: { "@type": "Organization", name: "Tirthon Tech" },
    url: "https://tirthontech.com/products/akna-terminal",
    keywords: [
