...
import { Building2, TrendingUp, Monitor, Zap, Star, Bot, Gem, ArrowRight, ExternalLink } from "lucide-react";
            ...
            >
              ...
              >
                ...
                <div className="mt-5 flex items-center justify-between gap-2">
                  ...
                  {product.liveUrl && (
                    <span className="text-[11px] font-semibold text-green-600 bg-green-500/10 px-2 py-1 rounded-full whitespace-nowrap">
                      Live product
                    </span>
                  )}
                </div>
              ...
              {product.liveUrl && (
                <a
                  ...
                  className="mt-2 flex items-center justify-center gap-1.5 text-xs font-semibold text-muted-foreground hover:text-primary border border-border/60 hover:border-primary/40 rounded-xl py-2 transition-colors no-underline"
                >
                  Try {product.name} free <ExternalLink className="w-3 h-3" />
                </a>
              )}
            </motion.div>
          ))}
